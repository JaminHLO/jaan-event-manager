    ...
    <div className="profile my-1  flex justify-center items-center min-h-[90vh]">
      <div className='p-5 bg-black opacity-80 w-1/2 h-auto rounded-2xl text-center transition ease-in-out delay-150 hover:opacity-90'>
        ...
        <form onSubmit={handleFormSubmit} encType='multipart/form-data'>
          ...
          <button
            className="mb-3 mt-2 transition ease-in-out delay-150 bg-red-900 cursor-pointer hover:bg-rose-950 text-white font-bold uppercase text-sm p-4 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
            type="button"
